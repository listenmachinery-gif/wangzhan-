...
export const singleTableFiberLaserCuttingMachinePage = {
  ...
  workflow: [
    ...
    { title: "Plate Rolling Machine", text: "Creates curved panels and cylinders.", href: "/products/series/plate-rolling-machines" },
    { title: "Hydraulic Press", text: "Supports forming, pressing and assembly tasks.", href: "/products/series/press-machines" },
  ...
  internalLinks: [
    ...
    { label: "CNC press brake", href: "/products/electro-hydraulic-servo-cnc-press-brake" },
    { label: "Plate rolling machine", href: "/products/series/plate-rolling-machines" },
    { label: "Hydraulic press", href: "/products/series/press-machines" },
