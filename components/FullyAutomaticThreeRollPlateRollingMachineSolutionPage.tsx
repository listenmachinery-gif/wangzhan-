...
import {
  applicationPhotos,
  confirmationValue,
  fullyAutomaticThreeRollPlateRollingMachinePage as page,
  type ContentCard,
  type SpecificationField,
} from "@/data/fully-automatic-three-roll-plate-rolling-machine-page";
...
const resolveSpecification = (product: Product, field: SpecificationField) => {
  ...
  if (field.source === "spec" && field.sourceIndex !== undefined) {
    ...
    if (spec?.label !== expectedSpecLabels[field.sourceIndex]) {
      throw new Error(
        `Unexpected fully automatic plate rolling specification at index ${field.sourceIndex}`,
      );
    }
    return spec.value;
  }
...
export default function FullyAutomaticThreeRollPlateRollingMachineSolutionPage({
  product,
}: Props) {
  const productSchema = {
  ...
  return (
    <main
      data-fully-automatic-three-roll-plate-rolling-machine-page
    ...
    >
      ...
      <section data-section="pain-points" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="What rolling problems can it solve?"
            text="Automation creates the most value when repeat settings, edge preparation, inspection and material handling are planned around the actual shell."
          />
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            label="Automatic rolling solutions"
            title="Fully automatic plate rolling solution"
            text="Select the rolling cell from the workpiece envelope, production quantity and required control level."
          />
      ...
      <section data-section="applications" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="Where automatic shell rolling supports production"
            text="These real photographs illustrate representative industries and downstream parts. Machine suitability is confirmed from your material and drawings."
          />
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.82fr_1.18fr]">
          <SectionIntro
            ...
            text="Suitable thickness depends on strength, width, diameter, pre-bending demand, roll structure, CNC process and machine configuration."
          />
      ...
      <section data-section="formed-shapes" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="What shapes can it form?"
            text="Final quality depends on the material, blank, target geometry, pre-bending process, CNC program and operating setup."
          />
          <ContentGrid items={page.shapes} columns="lg:grid-cols-5" />
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            label="Automatic rolling process"
            title="From flat plate to rolled shell"
            text="A programmed cycle belongs inside a complete path that still includes blank preparation, dimensional checks and downstream joining."
          />
      ...
      <section data-section="cnc-control" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl items-start gap-14 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            <Cpu className="h-9 w-9 text-[#76B900]" />
            <SectionIntro
              label="CNC control"
              title="CNC control for automatic rolling cycles"
              text="Confirm the controller, automation level, program complexity, feedback hardware and planned batch size before quotation."
            />
          </div>
          <ContentGrid items={page.cncControl} columns="lg:grid-cols-2" />
        </div>
      </section>

      <section
        data-section="pre-bending"
        className="border-y border-white/10 bg-[#0d1115] px-5 py-24 sm:px-8 lg:px-12"
      >
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div>
            <p className={labelClass}>Automatic pre-bending</p>
            <h2 className={headingClass}>{page.preBending.title}</h2>
            <p className="mt-6 text-base leading-8 text-zinc-400">{page.preBending.text}</p>
          </div>
          <div className="border border-white/10 bg-[linear-gradient(145deg,#11161a,#090b0d)] p-7 sm:p-10">
            ...
            <ul className="mt-7 grid gap-4 sm:grid-cols-2">
              {page.preBending.checks.map((item) => (
      ...
      <section data-section="three-roll-structure" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            label="Three-roll working principle"
            title="How fully automatic three-roll plate rolling works"
            text="The existing product photograph remains the source of truth for visible structure. Final roll movement, drive and discharge details follow the confirmed machine."
          />
          <ContentGrid items={page.structure} columns="lg:grid-cols-4" />
        </div>
      </section>

      <section
        data-section="feeding-unloading"
        className="border-y border-white/10 bg-[#0d1115] px-5 py-24 sm:px-8 lg:px-12"
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            label="Material handling"
            title="Feeding, centering and unloading options"
            text="Automation must be matched to plate size, plate weight, daily quantity, finished-shell geometry and the workshop lifting plan."
          />
          <div className="mt-12 grid gap-px bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
            {page.feedingUnloading.map((item, index) => {
              const Icon = [Layers3, SlidersHorizontal, PackageOpen, HardHat][index];
              return (
                <article key={item.title} className="bg-[#0d1115] p-7">
      ...
      <section data-section="advantages" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative min-h-[420px] border border-white/10 bg-[radial-gradient(circle_at_50%_45%,rgba(118,185,0,0.12),transparent_36%),#0d1115]">
            <Image
              src={product.image}
              alt="Fully automatic three-roll plate rolling machine overview"
              fill
              loading="lazy"
              unoptimized
          ...
          <div>
            <SectionIntro
              ...
              title="Why choose this fully automatic three-roll solution?"
            />
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="Fully automatic three-roll vs semi-automatic three-roll vs four-roll"
            text="Each structure serves a different workload. Final selection follows the workpiece, output, positioning needs and desired control level."
          />
          <div className="mt-12 overflow-x-auto border border-white/10">
            <table className="min-w-[980px] w-full border-collapse text-left">
              <thead>
                <tr className="bg-white/[0.05]">
                  <th className="p-5 text-xs uppercase tracking-wider text-zinc-500">
                    Selection point
                  </th>
                  <th className="p-5 text-sm font-semibold text-white">
                    Semi-automatic three-roll
                  </th>
                  <th className="border-x border-[#76B900]/25 bg-[#76B900]/[0.07] p-5 text-sm font-semibold text-[#92d82a]">
                    Fully automatic three-roll
                  </th>
                  <th className="p-5 text-sm font-semibold text-white">Four-roll</th>
                </tr>
              </thead>
              <tbody>
                {page.comparison.map((row) => (
                  <tr key={row.label} className="border-t border-white/10">
                    ...
                    <td className="p-5 text-sm leading-6 text-zinc-400">
                      {row.semiAutomaticThreeRoll}
                    </td>
                    <td className="border-x border-[#76B900]/20 bg-[#76B900]/[0.035] p-5 text-sm leading-6 text-zinc-200">
                      {row.fullyAutomaticThreeRoll}
                    </td>
                    <td className="p-5 text-sm leading-6 text-zinc-400">{row.fourRoll}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section data-section="fabrication-workflow" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="Build a complete automatic plate rolling workflow"
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="How to choose the right fully automatic three-roll machine"
            text="Send these inputs with a part drawing so the recommendation starts from the real process rather than a generic model name."
          />
      ...
      <section data-section="technical-specifications" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-4 text-xs leading-6 text-zinc-500">
            Final specifications depend on plate material, thickness, rolling length, target
            diameter, pre-bending requirement, CNC control, feeding system and selected machine
            configuration.
          </p>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="Prepare the production cell before installation"
          />
          <div className="mt-12 grid gap-px bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <section data-section="related-machines" className="px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
      ...
      >
        <div className="mx-auto max-w-4xl">
          <SectionIntro
            label="FAQ"
            title="Questions before selecting an automatic three-roll machine"
          />
