...
import { manualFoldingMachinePageContent } from "@/data/manual-folding-machine-page";
import type { Product } from "@/data/products";

type ManualFoldingMachineSolutionPageProps = {
  product: Product;
};
  ...
  return (
    <div className="relative overflow-hidden border border-white/10 bg-[#111417] p-6 sm:p-10">
      ...
      <svg
        viewBox="0 0 640 430"
        role="img"
        aria-label="Manual sheet metal clamping and edge folding diagram"
      ...
      >
        ...
        <circle cx="166" cy="172" r="18" fill="#111417" stroke="#76B900" strokeWidth="4" />
        <path d="M124 172H148M166 130V154M166 190V214" fill="none" stroke="#76B900" strokeWidth="4" strokeLinecap="round" />
...
export default function ManualFoldingMachineSolutionPage({
  product,
}: ManualFoldingMachineSolutionPageProps) {
  const content = manualFoldingMachinePageContent;
  const technicalParameters = product.technicalParameters;
  const productUrl =
    "https://www.zyroncnc.com/products/manual-sheet-metal-folding-machine";
  const productImage = `https://www.zyroncnc.com${product.image}`;

  if (!technicalParameters) {
    throw new Error("Manual Folding Machine technical parameters are required");
  }
  ...
  const productSchema = {
    ...
    image: productImage,
    url: productUrl,
    category: "Manual Sheet Metal Folding Machine",
    brand: {
      "@type": "Brand",
      name: "ZYRON",
    },
  ...
  return (
    <main
      data-product-solution-page="manual-sheet-metal-folding-machine"
    ...
    >
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            label="Solution Fit"
            title="Manual Sheet Metal Folding Solution"
            text="Three practical use profiles help determine whether manual folding matches the production rhythm and work environment."
            light
          />
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            label="Applications"
            title="Where Manual Folding Fits"
      ...
      <section data-section="process" className="px-5 py-16 sm:px-8 lg:py-24">
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            text="A clear manual sequence helps the operator control positioning, clamping and the finished edge before the next process."
          />
          <div className="relative mt-14 grid gap-4 lg:grid-cols-6 lg:gap-0">
            <div className="absolute left-[8.33%] right-[8.33%] top-6 hidden h-px bg-neutral-300 lg:block" />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-20">
          ...
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight text-white sm:text-5xl">
              Why Choose This Manual Folding Machine?
            </h2>
      ...
      >
        <div className="mx-auto max-w-7xl">
          <SectionIntro
            ...
            title="Manual Folding Machine vs Electric Folding Machine"
            text="Neither drive method is universally better. The practical choice depends on production frequency, available utilities and how much manual effort the workflow can accept."
          />
            ...
            <table className="w-full min-w-[860px] border-collapse text-left text-sm">
              <thead className="bg-[#111417] text-white">
                <tr>
                  ...
                  <th className="whitespace-nowrap px-5 py-5 font-semibold text-[#8DDA17]">Manual Folding Machine</th>
              ...
              <tbody>
                {content.comparison.map((row) => (
                  <tr key={row.item} className="border-t border-neutral-200 align-top">
                    ...
                    <td className="px-5 py-5 leading-7 text-neutral-700">{row.manual}</td>
      ...
      <section data-section="selection" className="px-5 py-16 sm:px-8 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:gap-20">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight text-neutral-950 sm:text-5xl">
              How to Choose the Right Manual Folding Machine?
            </h2>
          ...
          <aside className="self-start border-t-2 border-[#76B900] bg-[#111417] p-7 text-white shadow-[0_24px_70px_rgba(15,23,42,0.15)] sm:p-9 lg:sticky lg:top-28">
            ...
            <h3 className="mt-7 text-2xl font-semibold leading-tight">
              Send Your Sheet Metal Folding Requirement
            </h3>
      ...
      >
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight text-white sm:text-5xl">
              Manual Folding Machine Questions
            </h2>
